...
public:
    ...
    void setupUi(QDialog *MyDialog)
    {
        ...
        Enter = new QPushButton(MyDialog);
        Enter->setObjectName(QStringLiteral("Enter"));
        Enter->setGeometry(QRect(300, 230, 75, 23));
    ...
    void retranslateUi(QDialog *MyDialog)
    {
        ...
        Enter->setText(QApplication::translate("MyDialog", "\350\277\233\345\205\245\344\270\273\347\225\214\351\235\242", 0));
